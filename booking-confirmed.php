    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <p><i class="fa-solid fa-location-dot"></i> Gümüssuyu Mah. Inönü Cad. No:8, Istanbul 34437</p>
            </div>
            <div class="col-lg-6">
                <h4>$265</h4>
                <a href="#?" class="butten">Download</a>
            </div>
            <div class="col-lg-3">
                <div class="box">
                    <h4>Thur, Dec 8
...
<section class="booking-confirmed-sec2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h3>Contact Us</h3>
                <p>328 North Bridge Road,<br>
                    #02-20 Raffles Hotel Arcade,<br>
                    Singapore 188719</p>
            </div>
        </div>
    </div>
